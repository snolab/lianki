  ...
  content: {
    ...
    experiments: {
      immersion: {
        ...
        blurb: t({
          en: "Desktop websites for reading native Chinese, Japanese, English, French, Korean, Spanish and German — one per topic, so you can pick the register you want to learn and start clipping cards.",
          zh: "阅读母语级中文、日语、英语、法语、韩语、西班牙语和德语的桌面网站——每个主题一个，选好想学的语域，就能开始剪卡片。",
          ja: "中国語・日本語・英語・フランス語・韓国語・スペイン語・ドイツ語をネイティブの文章で読めるデスクトップサイト。トピックごとに一つずつ、学びたい文体を選んでカードを切り出せます。",
          ko: "중국어·일본어·영어·프랑스어·한국어·스페인어·독일어를 원어민 글로 읽을 수 있는 데스크톱 사이트. 주제별로 하나씩, 배우고 싶은 문체를 골라 카드를 만드세요.",
          fr: "Des sites web de bureau pour lire du chinois, japonais, anglais, français, coréen, espagnol et allemand natifs — un par sujet, pour choisir le registre à apprendre et commencer à découper des cartes.",
          es: "Sitios web de escritorio para leer chino, japonés, inglés, francés, coreano, español y alemán nativos: uno por tema, para elegir el registro que quieres aprender y empezar a recortar tarjetas.",
          de: "Desktop-Websites zum Lesen von nativem Chinesisch, Japanisch, Englisch, Französisch, Koreanisch, Spanisch und Deutsch — eine pro Thema, damit du das Register wählst, das du lernen willst, und Karten ausschneidest.",
        }),
      },
    },
  },
